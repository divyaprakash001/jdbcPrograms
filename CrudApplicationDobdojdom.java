...
public class CrudApplicationDobdojdom {

	public static void main(String[] args) throws SQLException, ParseException {
		Connection connection = null;
		PreparedStatement pstmt1 = null;
		PreparedStatement pstmt2 = null;
		PreparedStatement pstmt3b = null;
		PreparedStatement pstmt3j = null;
...
//		all types of query
		...
		try {
			...
			if (connection != null) {
				...
				pstmt3b = connection.prepareStatement(updateDob);
				pstmt3j = connection.prepareStatement(updateDoj);
				pstmt3m = connection.prepareStatement(updateDom);
				...
				do {
					...
					case 2: // insert
						...
						if (pstmt2 != null) {
							...
							pstmt2.setString(3, eadd);
							pstmt2.setString(4, egender);
							pstmt2.setDate(5, sDob);
							pstmt2.setDate(6, sDoj);
							pstmt2.setDate(7, sDom);
						...
						do {
							...
							case 1: // update name
								...
								if (pstmt3b != null) {
									...
									lb = uDob.getTime();
									sDob = new java.sql.Date(lb);
									pstmt3b.setDate(1, sDob);
									pstmt3b.setInt(2, id);
									rowAffected = pstmt3b.executeUpdate();
									if (rowAffected == 0) {
							...
							case 2: // update doj
								...
								if (pstmt3j != null) {
									...
									lj = uDoj.getTime();
									sDoj = new java.sql.Date(lj);
									pstmt3j.setDate(1, sDoj);
									pstmt3j.setInt(2, id);
									rowAffected = pstmt3j.executeUpdate();
									if (rowAffected == 0) {
										System.out.println("sorry data not found");
									} else {
